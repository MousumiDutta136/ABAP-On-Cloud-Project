...
define view entity ZCO_RAP_MD_SALES
with parameters I_Curr : abap.cuky( 5 )
 as select from ZI_RAP_MD_SALES as sales
 association of many to many ZI_RAP_MD_PRODUCT as _Product
 on $projection.ProductId = _Product.ProductId
{
    ...
    Amount,
    Currency,
    cast('USD' as abap.cuky( 5 )) as ConvertCurrency,
